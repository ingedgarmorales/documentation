...
.. important::
   ...
   already passed the Certification process for "Facturación y Mercado" in the SII. This
   certification enables you to generate electronic invoices from your ERP and send them
   automatically to the SII. If your company has not passed this certification yet, make sure you
   communicate this to your Account Manager as a special process outside Odoo is required in order
...
- GLOSA: ``Usuario sin permiso de envio.``
  ...
  *Hint:* This error indicates that most likely, your company has not passed the Certification
  process in the SII - Sistema de Facturación y Mercadeo. If this is the case, please contact your
  Account Manager or Customer Support as this certification is not part of the the Odoo services,

...
Odoo makes it easier than ever before for customers to access their
customer account.

Customers are suggested to sign up (name, email, password) only when an order
has been placed - *not* before.
...
This is where they will find their history. Their main address (billing) can also be modified
here, as well.
